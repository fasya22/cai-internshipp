            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="card m-b-30">
                        <div class="card-body">
                            <form action="{{ route('profil-mentor.update', $user->uid) }}" method="POST"
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="nama" name="nama"
                                        value="{{ old('nama', $mentor->nama) }}" data-parsley-pattern="^[a-zA-Z\s\-]+$"
                                        required>
                                    @error('nama')
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="email" class="form-control @error('email') is-invalid @enderror"
                                        id="email" name="email" value="{{ old('email', $mentor->user->email) }}"
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control" id="jenis_kelamin" name="jenis_kelamin">
                                        <option value="1" {{ $mentor->jenis_kelamin == 1 ? 'selected' : '' }}>
                                            Laki-laki</option>
                                        <option value="2" {{ $mentor->jenis_kelamin == 2 ? 'selected' : '' }}>
                                            Perempuan</option>
                                    </select>
                                </div>
                                {{-- <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="pendidikan_terakhir"
                                        name="pendidikan_terakhir" value="{{ $mentor->pendidikan_terakhir }}">
                                </div>
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="institusi_pendidikan_terakhir"
                                        ...
                                        value="{{ $mentor->institusi_pendidikan_terakhir }}">
                                </div> --}}
                                ...
                                <div class="form-group">
                                    ...
                                    @if ($mentor->image)
                                        <div>
                                            <img src="{{ asset('storage/images/' . $mentor->image) }}" alt="Foto Profil"
                                                style="max-width: 100px; margin-bottom: 8px; border-radius: 8px; border: 2px solid #ccc; padding: 4px;"
                                                onclick="showImageModal('{{ asset('storage/images/' . $mentor->image) }}')">
                                        </div>
                                    ...
                                    <img id="image_preview"
                                        src="{{ $mentor->image ? asset($mentor->image) : 'placeholder.jpg' }}"
                                        alt="Foto Profil" class="img-fluid mt-2" style="max-width: 200px; display: none;">
                                </div>
