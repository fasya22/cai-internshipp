                ...
                <div class="col-12">
                    <div class="card m-b-30">
                        <div class="card-body">
                            ...
                            <form action="{{ route('user-hrd.store') }}" method="post" enctype="multipart/form-data">
                                @csrf
                                        ...
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                <div class="form-group">
                                                    ...
                                                    <select class="form-control" name="hrd" onchange="getnamehrd()"
                                                        required>
                            ...
                            <table id="datatable" class="table table-bordered dt-responsive nowrap"
                                ...
                                <tbody>
                                    @foreach ($user_hrd as $key => $value)
                                        <tr>
                                            <td>{{ $key + 1 }}</td>
                                            <td>{{ $value->hrd->nama }}</td>
                                            <td>{{ $value->email }}</td>
                                            <td>
                                            ...
                                            <td>
                                                ...
                                                <form action="{{ route('user-hrd.update', $value->uid) }}"
                                                            ...
                                                            <div class="modal-content">
                                                                ...
                                                                <div class="modal-body">
                                                                    ...
                                                                    <div class="form-group">
                                                                        ...
                                                                        <input type="text" class="form-control" id="hrd" name="hrd" value="{{ $value->hrd['nama'] }}" readonly>
                                                                        <input type="hidden" name="hrd_uid" value="{{ $value->hrd['uid'] }}">
                                                                        @if ($errors->has('hrd'))
                                                                            <div class="error" style="color: red; display:block;">
                                                                                {{ $errors->first('hrd') }}
                                                                            </div>
                                                ...
                                                <form action="{{ route('user-hrd.destroy', $value->uid) }}"
