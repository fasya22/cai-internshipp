...
@section('content')
    ...
    <div class="content">
        <div class="container-fluid">
                                                                    ...
                                                                    <div class="modal-body">
                                                                        <div class="">
                                                                            <div class="label-value">
                                                                                ...
                                                                                <span class="value">:
                                                                                    {{ $value->peserta['nama'] ?? 'N/A' }}</span>
                                                                            </div>
                                                                            <div class="label-value">
                                                                                <span class="label">Posisi</span>
                                                                                <span class="value">:
                                                                                    {{ $value->lowongan['posisi'] ?? 'N/A' }}</span>
                                                                            </div>
                                                                            <div class="label-value">
                                                                                <span class="label">Periode</span>
                                                                                <span class="value">:
                                                                                    {{ $value->periode['judul_periode'] ?? 'N/A' }}</span>
                                                                            </div>
                                                                        </div>
                                                                        <hr>
                                                                        <div class="">
                                                                            <div class="label-value">
                                                                                ...
                                                                                <span class="value">:
                                                                                    @if ($value->cv)
                                                                                        <a href="{{ url('pdf/' . $value->cv) }}"
                                                                                            target="_blank">Curriculum Vitae <i class="fas fa-external-link-alt"></i>
                                                                                        </a>
                                                                                    @else
                                                                                        Tidak ada Curriculum Vitae
                                                                                    @endif
                                                                                </span>
                                                                            </div>
                                                                            <div class="label-value">
                                                                                <span class="label">Surat Lamaran Magang</span>
                                                                                <span class="value">:
                                                                                    @if ($value->surat_lamaran_magang)
                                                                                        <a href="{{ url('pdf/' . $value->surat_lamaran_magang) }}"
                                                                                            target="_blank">Surat Lamaran Magang <i class="fas fa-external-link-alt"></i>
                                                                                        </a>
                                                                                    @else
                                                                                        Tidak ada Surat Lamaran Magang
                                                                                    @endif
                                                                                </span>
                                                                            </div>
                                                                        </div>
                                                                        ...
                                                                        <div class="table-responsive">
                                                                            <table class="table table-bordered mb-0">
                                                                                <tbody>
                                                                                    ...
                                                                                    <tr>
                                                                                        <td><strong>Nilai Minimum:</strong>
                                                                                        </td>
                                                                                        <td>{{ $value->englishCertificate->nilai_minimum ?? 'N/A' }}
                                                                                        </td>
                                                                                    </tr>
                                                                                    <tr>
                                                                                        <td><strong>Nilai Bahasa
                                                                                                Inggris:</strong></td>
                                                                                        <td>{{ $value->nilai_bahasa_inggris ?? 'N/A' }}
                                                                                        </td>
                                                                                    </tr>
                                                                                    <tr>
                                                                                        ...
                                                                                        <td>
                                                                                            @if ($value->sertifikat_bahasa_inggris)
                                                                                                <a href="{{ url('pdf/' . $value->sertifikat_bahasa_inggris) }}"
                                                                                                    target="_blank">
                                                                                                    <button type="button"
            ...
            <div class="row mb-3">
                <div class="col-12">
                    <form action="{{ route('peserta-magang.index') }}" method="GET">
                        <div class="row mb-3">
                            ...
                            <div class="col-md-3 mb-3">
                                ...
                                <select class="form-control" id="periode" name="periode">
                                    ...
                                    @foreach ($periode as $item)
                                        <option value="{{ $item->id }}" data-year="{{ \Carbon\Carbon::parse($item->tanggal_mulai)->year }}" {{ request('periode') == $item->id ? 'selected' : '' }}>
                                            {{ $item->judul_periode }} ({{ \Carbon\Carbon::parse($item->tanggal_mulai)->translatedFormat('j F Y') }} - {{ \Carbon\Carbon::parse($item->tanggal_selesai)->translatedFormat('j F Y') }})
                                        </option>
                                    @endforeach
                                </select>
                            </div>
                            <div class="col-md-3 mb-3">
                                ...
                                <select class="form-control" id="posisi" name="posisi">
                                    ...
                                    @foreach ($posisi as $item)
                                        <option value="{{ $item->id }}" {{ request('posisi') == $item->id ? 'selected' : '' }}>
                                            {{ $item->posisi }}
                                        </option>
                                    @endforeach
                                </select>
                            ...
                            <div class="col-md-2 mb-3">
                                ...
                                <select class="form-control" id="mentor" name="mentor">
                                    ...
                                    @foreach ($mentor as $item)
                                        <option value="{{ $item->id }}" data-posisi="{{ $item->posisi_id }}" {{ request('mentor') == $item->id ? 'selected' : '' }}>
                                            {{ $item->nama }}
                                        </option>
                                    @endforeach
                                </select>
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="ex-page-content text-center">
                                    ...
                                    <h4 class="">Belum ada peserta magang</h4><br>
                                </div>
                            </div>
                        </div>
                    @else
                    {{-- <form action="{{ route('filterPeserta') }}" method="GET">
                        <div class="row">
                            @foreach ($magangData as $value)
                                <div class="col-lg-4">
                                    <div class="card m-b-30">
                                        <a href="{{ route('getlistpeserta', $value['lowongan_uid']) }}">
                                            <div class="card-body">
                                                <h4 class="card-title font-16 mt-0">{{ $value['posisi'] }} ||
                                                    {{ $value['periode_judul'] }}</h4>
                                                <p class="card-text">Jumlah Peserta: {{ $value['jumlah_peserta'] }}</p>
                                            </div>
                                        </a>
                                    </div>
                                </div>
...
<script>
    ...
    // Trigger change event on page load to apply the filter if a year is preselected
...
<script>
    $(document).ready(function() {
        ...
        var mentorText = $('#mentor option:selected').text();

        // Buat title berdasarkan nilai filter
        var titleText = 'Daftar Peserta Magang\n';
        ...
        if (mentorText !== 'Semua Mentor' && mentorText !== '') {
            titleText += ' Mentor ' + mentorText;
        }
