...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
	...
	<link rel="stylesheet" type="text/css" href="{{asset('home/css/templete.css')}}">
	<link class="skin" rel="stylesheet" type="text/css" href="{{asset('home/css/skin/skin-1.css')}}">
	<link rel="stylesheet" href="{{asset('home/plugins/datepicker/css/bootstrap-datetimepicker.min.css')}}"/>
	<!-- Revolution Slider Css -->
	<link rel="stylesheet" type="text/css" href="{{asset('home/plugins/revolution/revolution/css/layers.css')}}">
	<link rel="stylesheet" type="text/css" href="{{asset('home/plugins/revolution/revolution/css/settings.css')}}">
	<link rel="stylesheet" type="text/css" href="{{asset('home/plugins/revolution/revolution/css/navigation.css')}}">
